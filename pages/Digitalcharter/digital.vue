<template>
	<view class="order">	
		<uni-forms class="orderBody">
			...
			<uni-forms-item label="出行类型:" class="formItem">
			  <view>
				  <uni-data-checkbox 
				  selectedColor="#0FAEFF"
					...
					v-model="value" 
					:localdata="range" 
					@change="Tyepechange"></uni-data-checkbox>
			  </view>
			</uni-forms-item>
			<uni-forms-item>
					...
					<uni-popup type="center" ref="popup">
						<view class="CarType">
							...
							<uni-row>
								...
								<uni-col :offset="1" :span="8"><text class="carInfoText">可乘坐{{passengerNum}}人</text></uni-col>
							...
							<uni-row>
								<uni-col>
									<button type="default" class="confirmCar" @click="confirmCars">确定</button>
								</uni-col>
							</uni-row>
						</view>
					</uni-popup>
			...
			<uni-forms-item>
					<view class="confirm">
						<button @click="confirmInfo" type="default">下单</button>	
					</view>
			</uni-forms-item>	
		</uni-forms>
	</view>
